...
export const MID_NEBULA_PARALLAX_SOURCE =
  "./assets/images/parallax/NYR_PARALLAX_NEBULA_MID_V1.png";

export const MID_NEBULA_PARALLAX_CONFIG = Object.freeze({
  // Réglages visuels provisoires PACK 13 — non canoniques et non finaux.
  opacity: 0.12,
  horizontalAmplitudePixels: 6,
  verticalAmplitudePixels: 3,
  cycleDurationSeconds: 56
});

export function createMidNebulaParallax({
  createImage = () => new Image(),
  source = MID_NEBULA_PARALLAX_SOURCE,
  config = MID_NEBULA_PARALLAX_CONFIG
} = {}) {
