...
export const FAR_STARS_PARALLAX_SOURCE =
  "./assets/images/parallax/NYR_PARALLAX_STARS_FAR_V1.png";

export const FAR_STARS_PARALLAX_CONFIG = Object.freeze({
  // Réglages visuels provisoires PACK 12 — non canoniques et non finaux.
  opacity: 0.3,
  horizontalAmplitudePixels: 8,
  verticalAmplitudePixels: 4,
  cycleDurationSeconds: 40
});

export function createFarStarsParallax({
  createImage = () => new Image(),
  source = FAR_STARS_PARALLAX_SOURCE,
  config = FAR_STARS_PARALLAX_CONFIG
} = {}) {
